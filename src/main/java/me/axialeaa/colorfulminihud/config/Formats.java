...
public class Formats
{
  ...
  //   DIFFICULTY_FORMAT                = new ConfigString("infoDifficultyFormat", "{\"color\":\"white\",\"text\":\"" + "Local Difficulty: {local}.2f // {clamped}.2f (Day {day}d)\"}", "Format of infoDifficulty"),
  ...
  //   "Day time % {mod}d: {time}5d\"}", "Format of infoTimeDayModulo"),
    ...
    "{time}S\"}", "The format string for real time, see the Java SimpleDateFormat\nclass for the format patterns, if needed.");//,
